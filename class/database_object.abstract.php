 ...
 * database based objects in Archie. It attempts to do some standard
...
abstract class database_object {
	 ...
	 */
	public function get_info($uid,$table_name='') {
		...
		if (self::is_cached($table_name,$uid)) {
			return self::get_from_cache($table_name,$uid);
		}
		...
		self::add_to_cache($table_name,$uid,$row);
