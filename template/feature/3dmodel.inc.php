...
?>
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      ...
      <a href="<?php echo Config::get('web_path'); ?>/viewer/stl/feature/<?php echo scrub_out($model->uid); ?>" title="3D View"><img src="<?php echo Config::get('web_path'); ?>/media/3dmodel/<?php echo scrub_out($model->uid);?>/thumb" /></a>
      <?php } else { ?>
