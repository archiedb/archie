  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="text-center"><img class="text-center" src="<?php echo Config::get('web_path'); ?>/media/3dmodel/feature/<?php echo scrub_out($model->uid);?>/thumb" /></p>
        <p class="text-center"><?php echo scrub_out($model->notes); ?></p>
        <p>Are you sure you want to delete this 3D Model from <?php echo $feature->site->name . '-' . $feature->record; ?>? This operation can not be reversed.</p>
      </div>
      <div class="modal-footer">
        <form method="post" action="<?php echo Config::get('web_path'); ?>/content/delete/3dmodel">
          ...
          <input type="hidden" name="parent" value="feature" />
