  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>Are you sure you want to delete <code>(<?php echo scrub_out(basename($media->filename)); ?>)</code> from <?php echo $feature->site->name . '-' . $feature->catalog_id; ?>? This operation can not be reversed.</p>
      </div>
      <div class="modal-footer">
        <form method="post" action="<?php echo Config::get('web_path'); ?>/content/delete/media">
