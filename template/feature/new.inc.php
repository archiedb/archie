...
<div class="control-group span4<?php Error::display_class('description'); ?>">
  ...
  <div class="controls">
    <textarea placeholder="..." rows="4" cols="80" name="description" id="inputDescription" tabindex="1"><?php \UI\form_value('description'); ?></textarea>
  </div>
</div>
<div class="control-group span4 offset1<?php Error::display_class('initial_rn'); ?>">
  ...
  <div class="controls">
    <input id="inputInitialRN" name="initial_rn" type="text" tabindex="3" value="<?php \UI\form_value('initial_rn'); ?>" />
  </div>
</div>
<div class="control-group span4 offset1<?php Error::display_class('northing'); ?>">
  ...
  <div class="controls">
    <input tabindex="4" id="inputNorthing" name="northing" type="text" value="<?php \UI\form_value('northing'); ?>" />
  </div>
</div>
<div class="control-group span4 offset1<?php Error::display_class('easting'); ?>"> 
  ...
  <div class="controls">
    <input id="inputEasting" tabindex="5" name="easting" type="text" value="<?php \UI\form_value('easting'); ?>" />
  </div>
</div>
...
<div class="control-group span4 offset1<?php Error::display_class('elevation'); ?>">
  ...
  <div class="controls">
    <input tabindex="5" id="inputElevation" name="elevation" type="text" value="<?php \UI\form_value('elevation'); ?>" />
  </div>
</div>
