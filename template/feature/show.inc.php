...
<div class="page-header">
  ...
  <div class="btn-group">
    <a class="btn btn-info dropdown-toggle" data-toggle="dropdown" href="#">Sort Features By <span class="caret"></span></a>
...
<table class="table table-hover table-bordered table-condensed">
  <thead>
  <tr>
    <th><a href="<?php echo Config::get('web_path'); ?>/feature/sort/catalog_id">Catalog #</a> <?php $view->display_sort('catalog_id'); ?></th>
  	<th>Keywords</th>
    <th>Description</th>
    <th>&nbsp;</th>
  </tr>
