  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?php echo Config::get('web_path'); ?>/krotovina/image_edit">
        <p class="text-center"><img class="text-center" src="<?php echo Config::get('web_path'); ?>/media/image/krotovina/<?php echo scrub_out($image->uid);?>/thumb" /></p>
