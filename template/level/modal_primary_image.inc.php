...
?>
<div id="confirm_primary_image_<?php echo scrub_out($image->uid); ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-footer">
    ...
    <input type="hidden" name="image" value="<?php echo scrub_out($image->uid); ?>">
