...
<div class="page-header">
  ...
  <div class="btn-group">
    <a class="btn dropdown-toggle" data-toggle="dropdown" href="#">Sort Levels By <span class="caret"></span></a>
...
<table class="table table-hover table-bordered table-condensed">
  ...
  <tr>
    ...
    <th><a href="<?php echo Config::get('web_path'); ?>/level/sort/lsg_unit"><abbr title="Lithostratoigraphic Unit">L. U.</abbr></a></th>
