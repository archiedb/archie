...
<div id="confirm_delete_media_<?php echo scrub_out($media->uid); ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-body">
    ...
    <p>Are you sure you want to delete <span class="muted">(<?php echo scrub_out(basename($media->filename)); ?>)</span> from <?php echo $record->site . '-' . $record->catalog_id; ?>? This operation can not be reversed.</p>
  </div>
