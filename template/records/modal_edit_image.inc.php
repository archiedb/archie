  ...
  <div class="modal-diialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p class="text-center"><img class="text-center" src="<?php echo Config::get('web_path'); ?>/media/image/record/<?php echo scrub_out($image->uid);?>/thumb" /></p>
        <p class="text-center"><input type="text" class="span4" name="description" value="<?php $image->_print('notes'); ?>" /></p>
      </div>
