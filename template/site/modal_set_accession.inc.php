...
?>
<div id="set_accession" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <form method="post" action="<?php echo Config::get('web_path'); ?>/manage/site/setaccession">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h3 id="myModalLabel">Set Accession</h3>
  </div>
  <div class="modal-body">
    <em>Set the current Accession # for this Site. This will overwrite any existing accession set on this site. 
